...
if (!$noSheetsAssigned) {
    ...
    if ($action !== 'submit' && isset($_GET['edit']) && $_GET['edit'] === '1') {
        $redirectUrl .= '&edit=1';
    }
...
<div class="layout">
    ...
    <main class="content">
        ...
        <?php if ($noSheetsAssigned): ?>
            <div class="alert alert-info">You have no assigned grading sheet yet.</div>
        <?php else: ?>
            <?php if ($isLocked): ?>
